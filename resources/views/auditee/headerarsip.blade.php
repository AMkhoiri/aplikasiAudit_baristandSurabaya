        ...
        <div class="container" >
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div  class="navbar-nav">
              <a data-toggle="tooltip" data-placement="top" title="Daftar Pertanyaan" class="nav-item nav-link" id="link" href="{{url ('/auditee/lks-tindakan')}}">DAFTAR LKS
               @if ($lkstotal !=0)
                  <span class="badge badge-light" style="color:#3993d0; ">{{$lkstotal}}</span>
                @endif

              </a>
              <a  data-toggle="tooltip" data-placement="top" title="Lihat LKS"class="nav-item nav-link" id="link" href="{{url ('/auditee/daftartindakan')}}">TINDAKAN PERBAIKAN
