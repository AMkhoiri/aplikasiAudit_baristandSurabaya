        ...
        <div class="container" >
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div  class="navbar-nav">
              <a data-toggle="tooltip" data-placement="top" title="Daftar Pertanyaan" class="nav-item nav-link aleft" id="link" href="{{url ('auditor/daftarpertanyaan')}}">PERTANYAAN </a>
              <a  data-toggle="tooltip" data-placement="top" title="Lihat LKS"class="nav-item nav-link aleft" id="link" href="{{url ('auditor/daftarlks')}}">LKS</a>
              <a data-toggle="tooltip" data-placement="top" title="Lihat Tindakan Perbaikan" class="nav-item nav-link aleft" id="link" href="{{url ('auditor/lksver')}}">TINDAKAN PERBAIKAN

                @if ($tindakanlks !=0)
                  <span class="badge badge-light" style="color:#3993d0; ">{{$tindakanlks}}</span>
                @endif
              </a>
               <a data-toggle="tooltip" data-placement="top" title="Lihat Arsip" class="nav-item nav-link aleft" id="link" href="{{url ('auditor/arsip')}}">ARSIP </a>
               ...
               <div class="dropdown nav-item nav-link" style=""> <span class=" fa fa-user "  style="  color: white; "> </span> <a style="" id="link"  class="" data-toggle="dropdown" href="#">{{Auth::user()->username}} &nbsp; <span  class="fa fa-caret-down"></span></a>
                <ul class="dropdown-menu" id="dropdownn" style=" ">
                  <li><a href="{{ url('/logout') }}"
                                       ...
                                       document.getElementById('logout-form').submit();" id="links" class="nav-item nav-link aright"><span class="fa fa-sign-out" ></span> Logout </a>
                  <form id="logout-form" action="{{ url('/logout') }}" method="POST" style="display: none;">
                                {{ csrf_field() }}
                  </form> 
                  </li>

                  <li><a href="{{ route('changepassform') }}" id="links"  class="nav-item nav-link aright"> <span class="fa fa-key" ></span> Change Password</a></li>
